...
> **Directorios escaneados**: 01_Limpieza_de_Datos, Analisis_Econometrico, tools (15 módulos)
...
### [`cointegracion.py`](Analisis_Econometrico/src/cointegracion.py) — 🔗 conectado
...
### [`construir_curva_historica.py`](Analisis_Econometrico/src/construir_curva_historica.py) — ⚠️ sin referencias externas encontradas
...
### [`elasticidad.py`](Analisis_Econometrico/src/elasticidad.py) — 🔗 conectado
...
### [`estacionalidad_y_forecast.py`](Analisis_Econometrico/src/estacionalidad_y_forecast.py) — ⚠️ sin referencias externas encontradas
...
### [`exportar_resultados_powerbi.py`](Analisis_Econometrico/src/exportar_resultados_powerbi.py) — ⚠️ sin referencias externas encontradas
...
### [`fx_pricing.py`](Analisis_Econometrico/src/fx_pricing.py) — 🔗 conectado
