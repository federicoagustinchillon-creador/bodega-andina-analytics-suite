# 01_Limpieza_de_Datos · Bodega & Agroindustria Andina S.A.
...
Esta capa **01_Limpieza_de_Datos** implementa un pipeline automatizado, auditable y de calidad de grado de producción que transforma estos insumos crudos en un **Esquema en Estrella (Star Schema)** completamente saneado y listo para ser consumido por los modelos semánticos de Power BI / Fabric.
