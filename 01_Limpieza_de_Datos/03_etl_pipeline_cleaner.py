...
CAPA: 01_Limpieza_de_Datos - Data Pipeline Cleaner & Quality Auditor
...
def run_etl():
    ...
    prod_gold_path = os.path.join(GOLD_DIR, "Productos.csv")
    df_prod.to_csv(prod_gold_path, index=False, encoding="utf-8")

    audit_metrics["tablas_procesadas"]["Productos"] = {
    ...
    cc_gold_path = os.path.join(GOLD_DIR, "CentrosCosto.csv")
    df_cc.to_csv(cc_gold_path, index=False, encoding="utf-8")

    audit_metrics["tablas_procesadas"]["CentrosCosto"] = {
    ...
    cta_gold_path = os.path.join(GOLD_DIR, "PlanCuentas.csv")
    df_cta.to_csv(cta_gold_path, index=False, encoding="utf-8")

    audit_metrics["tablas_procesadas"]["PlanCuentas"] = {
    ...
    cal_gold_path = os.path.join(GOLD_DIR, "Calendario.csv")
    df_cal.to_csv(cal_gold_path, index=False, encoding="utf-8")

    audit_metrics["tablas_procesadas"]["Calendario"] = {
        "registros_leidos": 0,
    ...
    ventas_gold_path = os.path.join(GOLD_DIR, "Ventas.csv")
    df_sap.to_csv(ventas_gold_path, index=False, encoding="utf-8")

    audit_metrics["tablas_procesadas"]["Ventas"] = {
    ...
    opex_gold_path = os.path.join(GOLD_DIR, "GastosOperativos.csv")
    df_opex.to_csv(opex_gold_path, index=False, encoding="utf-8")

    audit_metrics["tablas_procesadas"]["GastosOperativos"] = {
    ...
    cap_gold_path = os.path.join(GOLD_DIR, "CapitalTrabajo.csv")
    df_cap.to_csv(cap_gold_path, index=False, encoding="utf-8")

    audit_metrics["tablas_procesadas"]["CapitalTrabajo"] = {
    ...
    rem_gold_path = os.path.join(GOLD_DIR, "ProduccionPlanta.csv")
    df_rem.to_csv(rem_gold_path, index=False, encoding="utf-8")

    audit_metrics["tablas_procesadas"]["ProduccionPlanta"] = {
