...
SUITE03_DIR = os.path.join(BASE_DIR, "03_Operations_SupplyChain_Plant")
TMDL_DIR = os.path.join(SUITE03_DIR, "03_Operations_SupplyChain_Plant.SemanticModel", "definition")
...
def test_duckdb_integration():
    ...
    base = os.path.join(BASE_DIR, "00_Data_Engineering_ETL")
