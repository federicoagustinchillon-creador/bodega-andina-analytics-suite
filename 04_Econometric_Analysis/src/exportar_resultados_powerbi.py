...
BASE = Path(__file__).resolve().parent.parent  # 04_Econometric_Analysis/
ROOT = BASE.parent
REAL = BASE / "data" / "real"
OUT = BASE / "outputs"
GOLD_02 = ROOT / "02_Commercial_Sales_Intelligence" / "02_Commercial_Sales_Intelligence.SemanticModel" / "definition" / "tables"
GOLD_ETL = ROOT / "00_Data_Engineering_ETL" / "curated_gold"
