...
GOLD_DIR = os.path.join(BASE_DIR, "Ingenieria_de_Datos", "curated_gold")
SUITE03_DIR = os.path.join(BASE_DIR, "Operaciones_y_Planta")
...
def test_duckdb_integration():
    ...
    base = os.path.join(BASE_DIR, "Ingenieria_de_Datos")
